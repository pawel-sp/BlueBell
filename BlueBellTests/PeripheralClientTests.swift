...
class PeripheralClientTests: XCTestCase {
    ...
    class MockCommandRequestQueue: PeripheralClient.CommandRequestQueue {
        ...
        override func add(request: BaseCommandRequest) {
    ...
    func testPerform_readCommand_correctCharacteristic_correctExpectation_correctCharacteristic() {
        ...
        XCTAssertEqual(self.mockCommandRequestQueue.addedRequests[0].characteristic?.uuidString, "331DE754-BF63-4332-8095-3B84DF4AE654")
        XCTAssertEqual(self.fakeCBPeripheral.readValueParameters.invokes, 1)
        XCTAssertEqual(self.fakeCBPeripheral.readValueParameters.characteristic?.uuidString, "14047276-33BC-4CF9-AC75-5CD111EC213D")
    }
    ...
    func testPerform_writeCommand_correctCharacteristic_correctExpectation_correctCharacteristic() {
        ...
        XCTAssertEqual(self.mockCommandRequestQueue.addedRequests.count, 1)
        XCTAssertEqual(self.mockCommandRequestQueue.addedRequests[0].characteristic?.uuidString, "331DE754-BF63-4332-8095-3B84DF4AE654")
        XCTAssertEqual(self.fakeCBPeripheral.writeValueParameters.invokes, 1)
        XCTAssertEqual(self.fakeCBPeripheral.writeValueParameters.params?.characteristic.uuidString, "14047276-33BC-4CF9-AC75-5CD111EC213D")
        XCTAssertNotNil(self.fakeCBPeripheral.writeValueParameters.params?.value)
